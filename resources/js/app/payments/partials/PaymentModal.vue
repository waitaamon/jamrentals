            ...
            <div class="py-3">
                <form class="space-y-4">
                    <div>
                        ...
                        <p v-if="errors.building" class="mt-2 text-sm text-red-600" id="building-error">
                            {{ errors.building[0] }}
                        </p>
                    </div>
                    <div>
                        <label for="building" class="block text-sm font-medium text-gray-700">House</label>
                        <div class="mt-1">
                            <multiselect
                                v-model="form.house"
                                :options="houses"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <date-picker class="inline-block h-full w-full" v-model="form.date_paid" id="date-paid">
                                <template v-slot="{ inputValue, togglePopover }">
                                    <div class="flex items-center">
                                        <button
                                            type="button"
                        ...
                        <p v-if="errors.date_paid" class="mt-2 text-sm text-red-600" id="date-paid-error">
                            {{ errors.date_paid[0] }}
                        </p>
                    </div>
                    <div class="flex items-center">
